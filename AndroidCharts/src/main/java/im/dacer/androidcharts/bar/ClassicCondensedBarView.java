...
@Deprecated
public class ClassicCondensedBarView extends ClassicBarView {

    private final int TEXT_LEFT_MARGIN;

    private LabelIndicatorMode labelIndicatorMode = LabelIndicatorMode.BELOW_CHART;

    public ClassicCondensedBarView(Context context) {
        this(context, null);
    }

    public ClassicCondensedBarView(Context context, AttributeSet attrs) {
        super(context, attrs);
        BAR_SIDE_MARGIN = 0;
        TEXT_LEFT_MARGIN =
